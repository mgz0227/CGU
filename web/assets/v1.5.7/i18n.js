(() => {
  ...
  const dictionaries = {
    zh: {
      ...
      'admin.admissionHelp': '可编辑申请人资料与备注；未建立学生档案的申请也可删除。确认录取后系统会自动建立学生档案、校内邮箱并发送入学通知。',
      ...
      'admin.admissionDeleteConfirm': '确定删除这条招生申请吗？已建立学生档案的申请不能删除。',
      'admin.admissionDeleteBlocked': '已建立学生档案的申请不能删除。',
      ...
      'admin.admissionIdentityLocked': '学生档案已建立，身份资料不可修改；备注仍可更新。',
      ...
      'admin.admissionCredentials': '初始登录凭据（仅显示一次）',
      'admin.admissionUsername': '登录账号',
      'admin.admissionPassword': '初始密码',
      'admin.admissionEmailDelivery': '入学通知已发送到申请邮箱。',
      'admin.admissionEmailPending': '申请邮箱通知尚未配置 SMTP，请安全转交初始凭据。',
      'admin.admissionCopyPassword': '复制初始密码',
      'admin.admissionCopied': '初始密码已复制。',
      'admin.admissionCopyFailed': '浏览器拒绝访问剪贴板，请使用密码旁的复制功能或安全地手动转交。',
      'admin.admissionAlreadyApproved': '该申请已处理，系统不会重复创建账号。',
      'admin.noAdmissions': '暂无招生申请。',
      'admin.studentsKicker': 'STUDENT SERVICES',
      'admin.studentsHelp': '维护学生身份资料、登录账号和生成的学校邮箱。',
    ...
    en: {
      ...
      'admin.admissionKicker': 'ADMISSIONS OFFICE',
      'admin.admissionHelp': 'Edit applicant details and notes. Delete applications before a student record exists; approval creates the student record, university mailbox, and onboarding notice automatically.',
      ...
      'admin.admissionDeleteConfirm': 'Delete this admissions application? Applications with a provisioned student record cannot be deleted.',
      'admin.admissionDeleteBlocked': 'Applications with a provisioned student record cannot be deleted.',
      ...
      'admin.admissionIdentityLocked': 'The student record is provisioned, so identity fields are locked; notes remain editable.',
      ...
      'admin.admissionCredentials': 'Initial sign-in details (shown once)',
      'admin.admissionUsername': 'Login account',
      'admin.admissionPassword': 'Initial password',
      'admin.admissionEmailDelivery': 'Onboarding notice sent to the applicant email.',
      'admin.admissionEmailPending': 'SMTP is not configured; transfer the initial details securely.',
      'admin.admissionCopyPassword': 'Copy initial password',
      'admin.admissionCopied': 'Initial password copied.',
      'admin.admissionCopyFailed': 'The browser blocked clipboard access. Transfer the password securely by another method.',
      ...
      'admin.studentsKicker': 'STUDENT SERVICES',
      'admin.studentsHelp': 'Maintain student identity, login accounts, and generated university mailboxes.',
