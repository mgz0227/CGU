(() => {
  ...
  const dictionaries = {
    zh: {
      ...
      'admin.externalDeliveryHelp': '需要在服务端配置 SMTP；校内邮箱记录仍会保留。',
      ...
      'admin.admissionHelp': '申请提交后只需同意录取；系统会自动建立学生档案、校内邮箱并发送入学通知。',
    ...
    en: {
      ...
      'admin.externalDeliveryHelp': 'Requires SMTP configuration on the server; the internal mailbox copy is always retained.',
      ...
      'admin.admissionKicker': 'ADMISSIONS OFFICE',
      'admin.admissionHelp': 'Approve an application once; CGU then creates the student record, university mailbox, and onboarding notice automatically.',
