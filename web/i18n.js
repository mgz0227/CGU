(() => {
  ...
  const dictionaries = {
    zh: {
      ...
      'admin.admissionHelp': '申请提交后可同意录取；未建立学生档案的申请也可删除。录取后系统会自动建立学生档案、校内邮箱并发送入学通知。',
    ...
    en: {
      ...
      'admin.admissionKicker': 'ADMISSIONS OFFICE',
      'admin.admissionHelp': 'Approve an application once, or delete it before a student record exists. Approval creates the student record, university mailbox, and onboarding notice automatically.',
